...
class ProductLayout extends Component {
    constructor(props) {
        ...
        if (path === "okna") {
            ...
            this.state.keywords = "пластиковые окна Витебск, окна Витебск, окна пвх, межкомнатые, входные, железные двери, входные двери в квартиру"
        ...
        if (path === "mezhkomnatnie" || path === "vhodnie") {
            if (path === "mezhkomnatnie") {
                ...
                this.state.keywords = "купить межкомнатные двери, межкомнатные двери в Витебске, межкомнатные, купить межкомнатные двери, купить двери межкомнатные"
            ...
            if (path === "vhodnie") {
                ...
                this.state.keywords = "купить входные двери, входные двери в Витебске, входные двери, входные двери в квартиру, железные двери, входные, купить входную дверь"
                                    ...
                                    <a href={`/product/${item.url}`} className="product-item" data-id="842" key={index}>
                                        <div className="product-item-wrapper">
                                            <div className="product-item-picture">
                                                <div><img src={`/product/${item.url}/${item.url}0.jpg`}
                                                          alt="belchik images"/></div>
                                            </div>
